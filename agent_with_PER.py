...
DQN based agent for LunarLander-v3 with Prioritized Experience Replay Buffer
"""
...
if __name__ == "__main__":
    ...
    if running_on_hpc:
        session_name = f"DQN_{hidden_units}h_{n_episodes}e_{datetime.datetime.now().strftime('%d-%m-%Y')}_PER_hpc"
    else:
